...
func TestSubscriptionWithCreateMutations(t *testing.T) {
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.Request{
				Request: `mutation {
					create_User(name: "John", age: 27, points: 42.1, verified: true) {
						name
					}
				}`,
				Results: []map[string]any{
			...
			testUtils.Request{
				Request: `mutation {
					create_User(name: "Addo", age: 31, points: 42.1, verified: true) {
						name
					}
				}`,
				Results: []map[string]any{
...
func TestSubscriptionWithUpdateMutations(t *testing.T) {
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.Request{
				Request: `mutation {
					update_User(filter: {name: {_eq: "John"}}, points: 45) {
						name
					}
				}`,
				Results: []map[string]any{
